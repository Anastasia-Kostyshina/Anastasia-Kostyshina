...
Я верстальщик с опытом почти 3 года и начинающий frontend-разработчик.
----------------------------------------------------------------------

Реализовала 10+ проектов, включая лендинги, многостраничные сайты и сайты на WordPress, используя HTML5, CSS3, JavaScript. Работаю с Figma и Pixso для верстки по макетам, применяю Less и Gulp для оптимизации.
